...
namespace Game.Utils
{
    ...
    public interface IStateEnter<TOwner> where TOwner : IOwner
    {
        void OnEnter(TOwner owner);
    }

    public interface IStateExit<TOwner> where TOwner : IOwner
    {
        void OnExit(TOwner owner);
    }

    public interface IStateUpdate<TOwner> where TOwner : IOwner
    {
        void OnUpdate(TOwner owner);
    }

    public interface IStateFixedUpdate<TOwner> where TOwner : IOwner
    {
    ...
    public readonly struct StateCache<TOwner> where TOwner : IOwner
    {
    ...
    public class StateMachine<TOwner> where TOwner : IOwner
    {
        ...
        public void FixedUpdate() => _currentState.OnFixedUpdate(_owner);
